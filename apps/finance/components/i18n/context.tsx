...
const STORAGE_KEY = "fm.finance.locale";
...
export function I18nProvider({ children }: { children: ReactNode }) {
  ...
  // this resolves.
  if (!ready) return <View style={{ flex: 1, backgroundColor: nocturne.bg }} />;
 ...
 * `I18nProvider` can mount at all — root `app/_layout.tsx`'s session-restoring label, both shown ahead of any `(app)`/`(auth)` layout.
 *
